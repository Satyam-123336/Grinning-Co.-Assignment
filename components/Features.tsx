...
export default function Features() {
  return (
    <section className="w-full py-16 md:py-24 border-y border-white/5 bg-black">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 lg:gap-8">
          {features.map((feature, i) => (
            ...
            >
              ...
              <h4 className="font-cormorant text-xl md:text-2xl text-white">
                {feature.title}
              </h4>
              <p className="font-spaceGrotesk text-slate-400 font-light text-xs md:text-sm">
                {feature.desc}
              </p>
            </motion.div>
          ))}
